...
// Cursor trail effect (optional - remove if too distracting)
...
// Initialize cursor trail on hover over certain elements
const interactiveElements = document.querySelectorAll('.btn, .project-card, .skill-category');
interactiveElements.forEach(element => {
    element.addEventListener('mouseenter', createCursorTrail);
});

// GitHub API Integration (optional - for dynamic project loading)
const loadGitHubProjects = async () => {
    try {
        const response = await fetch('https://api.github.com/users/independent-coder/repos?sort=updated&per_page=6');
